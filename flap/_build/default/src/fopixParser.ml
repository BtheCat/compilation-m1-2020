...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | LAND
    | INT of (
# 10 "src/fopixParser.mly"
      (Mint.t)
# 37 "src/fopixParser.ml"
  )
    | IN
    | IF
    | ID of (
# 11 "src/fopixParser.mly"
      (string)
# 44 "src/fopixParser.ml"
  )
    | GTE
    | GT
    | EXTERNAL
...
# 1 "src/fopixParser.mly"
   (* Emacs, be a -*- tuareg -*- to open this file. *)

  open FopixAST


# 76 "src/fopixParser.ml"
...
# 162 "src/fopixParser.mly"
                        (
  x
)
# 322 "src/fopixParser.ml"
          
        in
        let x =
          let x = 
# 154 "src/fopixParser.mly"
                         (
  Id x
)
# 331 "src/fopixParser.ml"
           in
...
# 338 "src/fopixParser.ml"
          
        in
        
# 36 "src/fopixParser.mly"
(
  DefineValue (x, e)
)
# 346 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
...
# 421 "src/fopixParser.ml"
          
        in
        let xs = 
# 232 "<standard.mly>"
    ( xs )
# 427 "src/fopixParser.ml"
         in
        let f =
          let x = 
# 158 "src/fopixParser.mly"
                                  (
  FunId x
)
# 435 "src/fopixParser.ml"
           in
...
# 442 "src/fopixParser.ml"
          
        in
        
# 42 "src/fopixParser.mly"
(
  DefineFunction (f, xs, e)
)
# 450 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 484 "src/fopixParser.ml"
         in
        
# 46 "src/fopixParser.mly"
(
  DefineValue (Id "_", e)
)
# 491 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 10 "src/fopixParser.mly"
      (Mint.t)
# 530 "src/fopixParser.ml"
        ) = Obj.magic n in
        let _3 : unit = Obj.magic _3 in
        let x : (
# 11 "src/fopixParser.mly"
      (string)
# 536 "src/fopixParser.ml"
        ) = Obj.magic x in
        let _1 : unit = Obj.magic _1 in
        let _endpos__0_ = _menhir_stack.MenhirLib.EngineTypes.endp in
        let _startpos = _startpos__1_ in
...
# 555 "src/fopixParser.ml"
          
        in
        
# 50 "src/fopixParser.mly"
(
  ExternalFunction (f, Int64.to_int n)
)
# 563 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 10 "src/fopixParser.mly"
      (Mint.t)
# 584 "src/fopixParser.ml"
        ) = Obj.magic x in
        let _endpos__0_ = _menhir_stack.MenhirLib.EngineTypes.endp in
        let _startpos = _startpos_x_ in
        let _endpos = _endpos_x_ in
        let _v : (FopixAST.expression) = let l = 
# 146 "src/fopixParser.mly"
(
  LInt x
)
# 594 "src/fopixParser.ml"
         in
        
# 56 "src/fopixParser.mly"
(
  Literal l
)
# 601 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 640 "src/fopixParser.ml"
           in
          
# 150 "src/fopixParser.mly"
(
  LFun f
)
# 647 "src/fopixParser.ml"
...
# 686 "src/fopixParser.ml"
         in
        
# 60 "src/fopixParser.mly"
(
  Variable x
)
# 693 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 787 "src/fopixParser.ml"
          
        in
        
# 68 "src/fopixParser.mly"
(
  Define (x, e1, e2)
)
# 795 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 884 "src/fopixParser.ml"
         in
        
# 76 "src/fopixParser.mly"
(
  IfThenElse (c, t, f)
)
# 891 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 948 "src/fopixParser.ml"
         in
        
# 81 "src/fopixParser.mly"
(
  FunCall (f, es)
)
# 955 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 998 "src/fopixParser.ml"
          
        in
        let b = 
# 132 "src/fopixParser.mly"
        ( "`+`"  )
# 1004 "src/fopixParser.ml"
         in
        let l = 
# 162 "src/fopixParser.mly"
                        (
...
# 1011 "src/fopixParser.ml"
         in
        
# 84 "src/fopixParser.mly"
                                                      (
  FunCall (FunId b, [l; r])
)
# 1018 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 1061 "src/fopixParser.ml"
          
        in
        let b = 
# 133 "src/fopixParser.mly"
        ( "`-`"  )
# 1067 "src/fopixParser.ml"
         in
        let l = 
# 162 "src/fopixParser.mly"
                        (
...
# 1124 "src/fopixParser.ml"
          
        in
        let b = 
# 134 "src/fopixParser.mly"
        ( "`*`"  )
# 1130 "src/fopixParser.ml"
         in
        let l = 
# 162 "src/fopixParser.mly"
                        (
...
# 1187 "src/fopixParser.ml"
          
        in
        let b = 
# 135 "src/fopixParser.mly"
        ( "`/`"  )
# 1193 "src/fopixParser.ml"
         in
        let l = 
# 162 "src/fopixParser.mly"
                        (
...
# 1250 "src/fopixParser.ml"
          
        in
        let b = 
# 136 "src/fopixParser.mly"
        ( "`>?`"  )
# 1256 "src/fopixParser.ml"
         in
        let l = 
# 162 "src/fopixParser.mly"
                        (
...
# 1313 "src/fopixParser.ml"
          
        in
        let b = 
# 137 "src/fopixParser.mly"
        ( "`>=?`" )
# 1319 "src/fopixParser.ml"
         in
        let l = 
# 162 "src/fopixParser.mly"
                        (
...
# 1376 "src/fopixParser.ml"
          
        in
        let b = 
# 138 "src/fopixParser.mly"
        ( "`<?`"  )
# 1382 "src/fopixParser.ml"
         in
        let l = 
# 162 "src/fopixParser.mly"
                        (
...
# 1439 "src/fopixParser.ml"
          
        in
        let b = 
# 139 "src/fopixParser.mly"
        ( "`<=?`" )
# 1445 "src/fopixParser.ml"
         in
        let l = 
# 162 "src/fopixParser.mly"
                        (
...
# 1502 "src/fopixParser.ml"
          
        in
        let b = 
# 140 "src/fopixParser.mly"
        ( "`=?`"  )
# 1508 "src/fopixParser.ml"
         in
        let l = 
# 162 "src/fopixParser.mly"
                        (
...
# 1565 "src/fopixParser.ml"
          
        in
        let b = 
# 141 "src/fopixParser.mly"
        ( "`&&`" )
# 1571 "src/fopixParser.ml"
         in
        let l = 
# 162 "src/fopixParser.mly"
                        (
...
# 1628 "src/fopixParser.ml"
          
        in
        let b = 
# 142 "src/fopixParser.mly"
        ( "`||`" )
# 1634 "src/fopixParser.ml"
         in
        let l = 
# 162 "src/fopixParser.mly"
                        (
...
# 1715 "src/fopixParser.ml"
         in
        
# 88 "src/fopixParser.mly"
(
  UnknownFunCall (f, es)
)
# 1722 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 1780 "src/fopixParser.ml"
         in
        
# 91 "src/fopixParser.mly"
                                                                (
  FunCall (FunId "read_block", [e; i])
)
# 1787 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 1869 "src/fopixParser.ml"
         in
        
# 96 "src/fopixParser.mly"
                                (
  FunCall (FunId "write_block", [e; i; v])
)
# 1876 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 1927 "src/fopixParser.ml"
         in
        
# 99 "src/fopixParser.mly"
                                                          (
  Define (Id "_", e1, e2)
)
# 1934 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 103 "src/fopixParser.mly"
(
  While (e, b)
)
# 1989 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 232 "<standard.mly>"
    ( xs )
# 2056 "src/fopixParser.ml"
         in
        
# 110 "src/fopixParser.mly"
(
  Switch (e, Array.of_list bs, Some d)
)
# 2063 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 232 "<standard.mly>"
    ( xs )
# 2116 "src/fopixParser.ml"
         in
        
# 114 "src/fopixParser.mly"
(
  Switch (e, Array.of_list bs, None)
)
# 2123 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
      ...
      (fun _menhir_env ->
        ...
        let _v : (FopixAST.expression) = 
# 117 "src/fopixParser.mly"
                             (
  e
)
# 2164 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 123 "src/fopixParser.mly"
(
  None
)
# 2370 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
      ...
      (fun _menhir_env ->
        ...
        let _v : (FopixAST.expression option) = 
# 127 "src/fopixParser.mly"
(
  Some e
)
# 2397 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
      ...
      (fun _menhir_env ->
        ...
        let _v : (FopixAST.t) = 
# 27 "src/fopixParser.mly"
(
  ds
)
# 2431 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 2492 "src/fopixParser.ml"
         in
        
# 241 "<standard.mly>"
    ( [ x ] )
# 2497 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 2542 "src/fopixParser.ml"
         in
        
# 243 "<standard.mly>"
    ( x :: xs )
# 2547 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 2574 "src/fopixParser.ml"
         in
        
# 241 "<standard.mly>"
    ( [ x ] )
# 2579 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 2620 "src/fopixParser.ml"
         in
        
# 243 "<standard.mly>"
    ( x :: xs )
# 2625 "src/fopixParser.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
let program =
  fun lexer lexbuf ->
    (Obj.magic (MenhirInterpreter.entry 0 lexer lexbuf) : (FopixAST.t))
